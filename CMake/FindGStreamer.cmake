...
message(WARNING "For: ${CMAKE_SYSTEM_NAME}") # Need this for cross compiling.
...
if (CMAKE_SYSTEM_NAME STREQUAL "Windows")
    message(WARNING "Searching GStreamer Directory for Windows Host")
    find_file(
        GStreamer_INCLUDE_DIR
        NAMES gstreamer-1.0 libgstreamer-1.0
        PATHS /usr/mingw64/bin/
    )
else()
    find_library(GStreamer_LIBRARY
        NAMES gstreamer-1.0 libgstreamer-1.0
        PATHS ${PC_GStreamer_LIBRARY_DIRS} /usr/mingw64/bin/
        NO_DEFAULT_PATH
        NO_CMAKE_FIND_ROOT_PATH
        REQUIRED
    )
